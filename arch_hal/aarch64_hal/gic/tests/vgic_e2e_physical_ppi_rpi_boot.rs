...
// Exercises the rpi_boot-like asserted-PPI path with drop-and-deactivate EOIs.
include!("support/vgic_e2e_physical_ppi.rs");

const TEST_NAME: &str = "vgic_e2e_physical_ppi_rpi_boot";
const RUN_TEST: RunTest = common::run_el2_rpi_boot_like;
