...
vmcs_fields! {
    ...
    GUEST_PDPTE0 = 0x280a => (WIDTH_64, GUEST_STATE, 5);
    GUEST_PDPTE1 = 0x280c => (WIDTH_64, GUEST_STATE, 6);
    GUEST_PDPTE2 = 0x280e => (WIDTH_64, GUEST_STATE, 7);
    GUEST_PDPTE3 = 0x2810 => (WIDTH_64, GUEST_STATE, 8);
